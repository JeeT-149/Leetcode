...
**Language:** Java
**Status:** ACCEPTED
**Problem:** [Maximum Number of Non-overlapping Palindrome Substrings](https://leetcode.com/problems/maximum-number-of-non-overlapping-palindrome-substrings/)
**Topics:** Two Pointers, String, Dynamic Programming, Greedy
**Patterns (inferred):** Two Pointers, Dynamic Programming, Greedy
